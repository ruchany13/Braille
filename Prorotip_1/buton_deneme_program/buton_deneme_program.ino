...
void deneme(int sayac_toplami, int sayac)
{
  while (durum_menu == LOW)
  {


    if (durum_yukari == HIGH and sayac_toplami < 29)
    {
      sayac++;
      delay(200);
      ses(sayac);
    ...
    else if (sayac == sayac_toplami)
    {
      sayac = 0;
    }

    else if ( durum_asagi == HIGH and sayac_toplami > 0)
    {
      sayac--;
      delay(200);
      ses(sayac);
